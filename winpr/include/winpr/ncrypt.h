...
#define MS_KEY_STORAGE_PROVIDER ((const WCHAR*)u"Microsoft Software Key Storage Provider")
#define MS_SMART_CARD_KEY_STORAGE_PROVIDER ((const WCHAR*)u"Microsoft Smart Card Key Storage Provider")

#define MS_SCARD_PROV ((const WCHAR*)u"Microsoft Base Smart Card Crypto Provider")

#define MS_PLATFORM_KEY_STORAGE_PROVIDER ((const WCHAR*)u"Microsoft Platform Crypto Provider")

#define NCRYPT_CERTIFICATE_PROPERTY ((const WCHAR*)u"SmartCardKeyCertificate")
#define NCRYPT_NAME_PROPERTY ((const WCHAR*)u"Name")
#define NCRYPT_UNIQUE_NAME_PROPERTY ((const WCHAR*)u"Unique Name")
#define NCRYPT_READER_PROPERTY ((const WCHAR*)u"SmartCardReader")

/* winpr specific properties */
#define NCRYPT_WINPR_SLOTID ((const WCHAR*)u"Slot")
